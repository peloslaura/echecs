...
Ce code passe les tests 1. **Dans jeu.cpp une section est commentée: c'est ma tentative de passer les tests 2 (détection de l'échec).** Les tests qui échouent : 2, 3 et 4.
...
**Il n'y a pas de classe square** Plutôt que de représenter l'échiquier comme un ensemble de case, je le représente comme un ensemble de 64 positions. 