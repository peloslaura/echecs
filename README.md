...
Ce code passe les tests 1. (c'est à dire ...)
...
**Il n'y a pas de classe square** Plutôt que de représenter l'échiquier comme un ensemble de cases, je le représente comme un ensemble de 64 positions. 
